# Graph Report - D:\Projects\kaspa-gateway-rust  (2026-07-28)

## Corpus Check
- 10 files · ~36,177 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3985 nodes · 10211 edges · 188 communities (166 shown, 22 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 132 edges (avg confidence: 0.71)
...
Cohesion: 0.05
Nodes (90): Cli, Commands, database_manager_from_default_user_dir(), database_paths_from_default_user_dir(), main(), Box, Error, Result (+82 more)
...
Cohesion: 0.07
Nodes (83): controller(), kgw_all_parallel_node_bridge_plans_v1(), kgw_apply_bridge_active_instance_runtime_overrides_r110f(), kgw_apply_command_preview_overrides(), kgw_bridge_command_preview_instance_listens_r123(), kgw_bridge_config_path_from_preview_r122(), kgw_bridge_instance_value_r110f(), kgw_bridge_instance_value_r120() (+75 more)
...
Cohesion: 0.07
Nodes (30): assert, assertIncludes(), ClassList, configuredTauriInvokeResolverTests(), createHarness(), dataKey(), dynamicClickTests(), extractBetween() (+22 more)
...
Cohesion: 0.07
Nodes (32): applyBindings(), applyTheme(), bindShellControls(), getTauriInvoke(), initializedTabs, installFooterLinksOwnerPatch(), isInsideExplorer(), isTopTabControl() (+24 more)
...
Cohesion: 0.24
Nodes (27): backup_all_databases_with_label(), copy_if_exists(), database_paths_for_root(), db_operation_result(), file_status(), find_existing_file(), kgw_settings_database_backup(), kgw_settings_database_clear_caches() (+19 more)
...
Cohesion: 0.18
Nodes (16): address_record_from_row(), AddressRecord, DbError, is_kaspa_address_like(), KnownNameRecord, normalize_direction(), normalize_tx_type(), now_ms() (+8 more)

### Community 66 - "TransactionRecord"
Cohesion: 0.12
Nodes (7): AddressesRepository, AppCacheRepository, AsRef, Option, Path, Self, TransactionRecord
...
Cohesion: 0.14
Nodes (19): activateTab(), allTabIds(), currentSelectedTabId(), ensureCss(), importTabModule(), initTab(), kgwShellCanonicalDefaultTabR63F(), kgwShellCanonicalVisibleTabsR63F() (+11 more)

### Community 72 - "boot"
Cohesion: 0.21
Nodes (19): applyTabs(), bindNavigation(), boot(), kgwCloseCalendarPopoversForTabLifecycleR11B(), kgwMainTabTraceR35C(), kgwShellApplyDisplayPreferencesDirectR73(), kgwShellAsArrayR75(), kgwShellDisplayOwnerActiveButtonR59C() (+11 more)
...
### Community 82 - "apply"
Cohesion: 0.23
Nodes (16): apply(), defaults(), kgwShellApplyDisplayOwnerBeforeBootR63F(), kgwShellDisplayOwnerPreferredTabIdR59C(), kgwShellDisplayOwnerPublishR59C(), kgwShellDisplayOwnerResolveTabIdR59C(), kgwShellDisplayOwnerTabButtonsR59C(), kgwShellDisplayOwnerTabIdVisibleR59C() (+8 more)
...
Cohesion: 0.27
Nodes (10): kgwShellApplyLooseMenuVisibilityR75(), kgwShellApplySelectVisibilityR75(), kgwShellCollectSelectsForKindR75(), kgwShellKnownCurrenciesR75(), kgwShellKnownLanguagesR75(), kgwShellOptionValueR75(), kgwShellSelectIsExplicitShellOwnerR78(), kgwShellSelectLooksLikeSetR75() (+2 more)
...
Cohesion: 0.20
Nodes (10): Bridge management, Explorer and analysis, i18n gates, i18n rule, Internationalization, Main features, Multi-network runtime management, Node management (+2 more)
...
Cohesion: 0.48
Nodes (5): Get-CommandLineSummary(), Get-GatewayProcesses(), Write-Diagnostic(), Write-PortSnapshot(), Write-ProcessSnapshot()
...
## Knowledge Gaps
- **428 isolated node(s):** `tabRegistry`, `TAB_IDS`, `ANALYSIS_STATE`, `analysisRows`, `filteredRows` (+423 more)
...
- **Why does `default_user_data_dir()` connect `kaspa-gateway-config/src/lib.rs` to `export_commands.rs`, `app_logger.rs`, `commands.rs`, `top_addresses_deep.rs`, `settings_commands.rs`, `AppRuntime`, `python_migration_real.rs`, `migration.rs`, `config_commands.rs`, `analysis_commands.rs`, `export_system.rs`, `real_reports.rs`, `i18n_commands.rs`, `address_book.rs`, `explorer_services.rs`, `security_hardening.rs`, `persistent_logs.rs`, `transaction_analysis.rs`, `settings.rs`, `database_root`, `explorer_tab.rs`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **What connects `tabRegistry`, `TAB_IDS`, `ANALYSIS_STATE` to the rest of the system?**
